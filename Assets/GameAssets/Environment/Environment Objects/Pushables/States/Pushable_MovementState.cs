...
public class Pushable_MovementState : FullGridMoveableState
{
    Vector3 srcPosition;
    ...
    bool inSrcBlock;
    public Pushable_MovementState(FullGridMoveable fgm, StateMachine stateMachine) : base(fgm, stateMachine)
    {
    }
